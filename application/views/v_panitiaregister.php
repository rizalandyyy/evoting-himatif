                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" method="POST"
                                action="<?php echo base_url('panitia/signup') ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="text" name="divisi"
                                ...
                                <div class="form-group m-b-0 m-t-10 ">
                                    <div class="col-sm-12 text-center ">
                                        Sudah punya akun? <a href="<?php echo base_url('panitia/login') ?>"
