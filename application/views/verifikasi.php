        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Akun Anda sedang kami verifikasi</h2>
                    <h5><i> Lakukan login secara berkala untuk cek keaktifan akun Anda dan dapat melakukan voting di
                            sistem
                            kami</i></h5>
                    <br><br>
                    <h6><a href="<?php echo base_url('login') ?>"> <span style="background: #3498db;
    color: #fff;
    border-radius: 50px;
    margin: 0 0 0 30px;
    padding: 10px 25px;">Login</span></a></h6>
                </div>
            </div>
